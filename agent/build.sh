...
#   マイクは起動から終了まで回し続ける。休止中も発話の判定だけは要るため (ADR-0014)。
#   **回すことと記録することは別**なので、文面は記録するほうを書く。
#
...
#   「何を」だけでなく「いつ」も書く。ADR-0014 で、自分の発話が10分途切れたら記録を
#   休止するようにした。「会議中とみなせる間だけ」が実装に支えられるようになっている。
#
...
<dict>
	...
	<string>マイクが拾う音のレベルを記録し、入力が小さすぎるなど相手に届きにくくなる原因に気づけるようにします。記録するのは会議中とみなせる間だけで、音声の内容は記録しません。</string>
	<key>NSAudioCaptureUsageDescription</key>
	<string>このMacで鳴っている音のレベルを記録し、相手の声が聞き取りづらいことに気づけるようにします。記録するのは会議中とみなせる間だけで、音声の内容は記録しません。</string>
</dict>
</plist>
PLIST
